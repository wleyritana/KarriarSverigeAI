...
def culture_analysis(company, culture, reviews, lang):
    return llm(f"You analyze company culture alignment. {lang_rule(lang)}",
               f"Compare official culture vs employee reviews and identify risks and alignment insights. Company:{company} Official:{culture} Reviews:{reviews}")
